...
import { getSmoAppealsCount } from "actions/admin";
import { fontStyles } from "styledMixins/mixins";

const fromDate = dayjs().add(-1, "month");
const toDate = dayjs();

class SmoAppealsCount extends PureComponent {
    state = {
        params: {
    ...
    onClick = async () => {
        ...
        window.open(
            `${BASE_URL}/${
                adminPaths.GET_STATISTIC_SMO_APPEALS_COUNT_XLS
    ...
    render() {
        ...
        return (
            <Wrapper>
                ...
                <FetchingList
                    params={params}
                    action={getSmoAppealsCount}
                    reducerName={"admin"}
                    objectName={"smoAppealsCount"}
                ...
                <InfoWrapper>
                    ...
                    <ItemInfo>
                        <ItemReviews>
                            <ItemBody>
                                <Item>
                                    <Title>Всего обращений: </Title>
                                    <MarksItem> {count}</MarksItem>
                                </Item>
                            </ItemBody>
                        </ItemReviews>
                    </ItemInfo>
                    <ItemInfo>
                        <ItemReviews>
                            <ItemBody>
                                <Item>
                                    <Title>Вопрос: </Title>
                                    <MarksItem> {questionsCount}</MarksItem>
                                </Item>
                            </ItemBody>
                        </ItemReviews>
                    </ItemInfo>
                    <ItemInfo>
                        <ItemReviews>
                            <ItemBody>
                                <Item>
                                    <Title>Отзыв: </Title>
                                    <MarksItem>{reviewsCount}</MarksItem>
                                </Item>
                            </ItemBody>
                        </ItemReviews>
                    </ItemInfo>
                    <ItemInfo>
                        <ItemReviews>
                            <ItemBody>
                                <Item>
                                    <Title>Жалоба: </Title>
                                    <MarksItem>{complaintsCount}</MarksItem>
                                </Item>
                            </ItemBody>
                        </ItemReviews>
                    </ItemInfo>
...
export default SmoAppealsCount;
