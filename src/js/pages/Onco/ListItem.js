...
import Description from "pages/Onco/Description";
...
class ListItem extends PureComponent {
    ...
    render() {
        ...
        const { diagnosisName } = item; // this item contains all details about archive element
        //  TODO:: make layout for archive element
        return (
            <ListItemWrapper
                key={`item-id-${index}`}
            ...
            >
                <InfoWrapper>
                    <ItemInfo>
                        ...
                        <ItemName>{diagnosisName}</ItemName>
                    </ItemInfo>
                </InfoWrapper>
            </ListItemWrapper>
        );
