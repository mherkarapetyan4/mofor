...
import { notificationActionHandler } from "actions/pregnancy";
...
@connect()
@withTheme
class PregnancyMeasuringResults extends PureComponent {
    actions = (kind) => {
        let tooltip = "",
            action = () => {},
            icon = <></>;
                ...
                action: () => {
                    ...
                    dispatch(
                        notificationActionHandler(
                            { id },
                            pregnancyPath.CURRENT_NOTIFICATION_SUPPRESS,
                        ),
                    );
                },
...
PregnancyMeasuringResults.propTypes = {
...
export default PregnancyMeasuringResults;
